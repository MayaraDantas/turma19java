...
import br.com.generation_turma_19.farmacia.repository.CategoriaRepository;
...
public class CategoriaController {
	...
	private ResponseEntity<List<Categoria>> findByTipoCategoria(@PathVariable String tipo) {
	...
	@PutMapping
	private ResponseEntity<Categoria> putCategoria(@RequestBody Categoria categoria) {
